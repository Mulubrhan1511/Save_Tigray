...
export const Home = () => {
  ...
  <div class="flex items-center lg:mr-4 lg:order-2">
    ...
    <p style={{ color: "#454545", fontSize: "1em" }} className="pl-6"> we aim to bring student's to back school </p>
  </div>
  <div class="flex min-h-screen items-center justify-center flex-col pt-8">
