    ...
    <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            ...
            <div className="px-4 py-3 w-72">
                <span className="text-gray-400 mr-3 uppercase text-xs">Gift package</span>
                <p className="text-lg font-bold text-black truncate block capitalize">education matterial</p>
                <div className="flex items-center">
                    <p className="text-lg font-semibold text-black cursor-auto my-3">$10</p>
                    <del>
                        <p className="text-sm text-gray-600 cursor-auto ml-2">700 birr</p>
                    </del>
        ...
        <a href="#">
            ...
            <div className="px-4 py-3 w-72">
                ...
                <div className="flex items-center">
                    <p className="text-lg font-semibold text-black cursor-auto my-3">$10</p>
                    <del>
                        <p className="text-sm text-gray-600 cursor-auto ml-2">$700</p>
                    </del>
                    <div className="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                            fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
                            <path fillRule="evenodd"
